...
const en = {
  ...
  'form.worker.keyPh': 'X-Speedtest-Key auth value',
  'form.worker.hint': 'Sent as the X-Speedtest-Key header to your self-hosted Worker; URL and key are editable.',
...
const cn: Record<TKey, string> = {
  ...
  'form.worker.keyPh': 'X-Speedtest-Key 鉴权值',
  'form.worker.hint': '作为 X-Speedtest-Key 请求头发给你的自建 Worker;URL 与 Key 均可修改。',
